...
python 3 docker image with a custom, executable script [executeSubmission.py](https://github.com/comp350spring2021/SubmitterProject/blob/main/executables/executeSubmission.py) installed that will execute the submitted 
